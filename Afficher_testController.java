...
public class Afficher_testController implements Initializable {
    ...
    @FXML
    private JFXComboBox<Integer> combo_class;
...
ServiceClass sc=new ServiceClass();
     try {
           ...
           ObservableList<Integer> data3=FXCollections.observableArrayList(sc.getId_Class());
...
affich(st);
    ...
    private void add(MouseEvent event) throws IOException, SQLException {
        Projet.id_class=this.combo_class.getSelectionModel().getSelectedItem();
        ServiceClass sc=new ServiceClass();
        Projet.nom_classe=sc.getc(this.combo_class.getSelectionModel().getSelectedItem()).getNom_class();
