...
public class Front_cours2Controller implements Initializable {
  ...
  ArrayList<String> list=new ArrayList<>();
    ...
    private void play(MouseEvent event) {   
              TextToSpeech_1 tts = new TextToSpeech_1();
          
        tts.speak(target_translated);
    ...
    private void chang(Event event) {
     ...
     this.label_id.setText(target_translated);
        ...
        {
           target_translated=GoogleTTS_Translate.google_Translate(Language.ENGLISH,Projet.S.replaceAll("\\n+","\\s1")).replaceAll("1","\n");
        System.out.print(target_translated);
     this.label_id.setText(target_translated);
    ...
    private void back(MouseEvent event) throws IOException {
        Stage stage=(Stage)this.id_back1.getScene().getWindow();
       Parent root=FXMLLoader.load(getClass().getResource("front_cours1.fxml"));
       Scene scene=new Scene(root);
      stage.setScene(scene);
      stage.show();
